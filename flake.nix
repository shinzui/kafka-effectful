{
  description = "Effectful bindings for hw-kafka-client";
  ...
  # the imported ./nix modules. This project is dev-shell-only: consumers build
  # the package from source elsewhere, so there is no package build here.
