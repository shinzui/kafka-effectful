...
# cabal + HLS). This project is dev-shell-only (no package build). Add
# project-specific dev tools via `haskellProject.extraDevPackages` or directly in
# the extraNativeBuildInputs list below.
#
